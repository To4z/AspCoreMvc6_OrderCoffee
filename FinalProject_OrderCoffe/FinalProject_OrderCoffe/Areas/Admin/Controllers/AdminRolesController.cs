...
namespace FinalProject_OrderCoffe.Areas.Admin.Controllers
{
    ...
    public class AdminRolesController : Controller
    {
        ...
        public AdminRolesController(CfOderContext context, INotyfService otyfService)
        {
            _context = context;
            _notifyService = otyfService;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Roles != null ? 
                          ...
                          Problem("Entity set 'CfOderContext.Roles'  is null.");
        }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("RoleId,RoleName,Description")] Role role)
        {
            ...
            _notifyService.Success("Chỉnh sửa thành công");
            return View(role);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CfOderContext.Roles'  is null.");
            }
            var role = await _context.Roles.FindAsync(id);
            if (role != null)
            {
            ...
            await _context.SaveChangesAsync();
            _notifyService.Success("Xoá thành công");
            return RedirectToAction(nameof(Index));
        }
